package com.imrkjoseph.ispeed.dashboard.screens.speed_test
...
import com.imrkjoseph.ispeed.app.foundation.BaseFragment
...
import com.imrkjoseph.ispeed.app.shared.widget.DialogFactory.Companion.showCustomResultDialog
import com.imrkjoseph.ispeed.app.util.HttpDownloadTest
import com.imrkjoseph.ispeed.app.util.HttpUploadTest
import com.imrkjoseph.ispeed.app.util.PingTest
import com.imrkjoseph.ispeed.app.util.SpeedTestHandler
import com.imrkjoseph.ispeed.databinding.FragmentSpeedTestBinding
import com.imrkjoseph.ispeed.databinding.WidgetScreenToolbarBinding
        ...
        instruction.setOnClickListener {
            DialogFactory.showCustomInfoDialog(
                ...
                dialogAttributes = DialogFactory.InformationDialogAttributes(
                    ...
                    firstLineTitle = requireContext().getString(com.imrkjoseph.ispeed.R.string.instructions_manual_tracking),
                    secondLineTitle = requireContext().getString(com.imrkjoseph.ispeed.R.string.instructions_automatic_tracking),
                    thirdLineTitle = requireContext().getString(com.imrkjoseph.ispeed.R.string.instructions_geo_map_tracking)
                )
            )
        }
